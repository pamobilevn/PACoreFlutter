...
/// [PaDistanceUtils] - gives different functions that can be used for calculating or formatting distance
...
class PaLatLng {
  ...
  PaLatLng(this.latitude, this.longitude);
}

class PaDistanceUtils {
  ...
  static double calculateDistanceBetweenTwoLtnLng(
      PaLatLng origin, PaLatLng destination) {
