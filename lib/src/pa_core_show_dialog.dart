              ...
              actions: <Widget>[
                ...
                FlatButton(
                  ...
                  print(_pickYearWidgetState.year);
                   ...
                   if (!pref.containsKey("USER'S_AGE")) {
                     pref.setInt("USER'S_AGE",
                         DateTime.now().year - _pickYearWidgetState.year);
                     pref.setString("MAX_AD_CONTENT", maxAdContent);
                     pref.setBool("IS_VERIFY_AGE", true);
                     pref.setString(
                         "PRIVACY_POLICY",
                         DateTime.now()
                             .toString()
                     ...
                     pref.remove("USER'S_AGE");
                     pref.remove("MAX_AD_CONTENT");
                     pref.remove("IS_VERIFY_AGE");
                     pref.remove("PRIVACY_POLICY");
                     pref.setInt("USER'S_AGE",
                         DateTime.now().year - _pickYearWidgetState.year);
                     pref.setString("MAX_AD_CONTENT", maxAdContent);
                     pref.setBool("IS_VERIFY_AGE", true);
